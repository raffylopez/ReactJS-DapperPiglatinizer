...
export const syncedTypingReducer = (state = {text:""}, action) => {
  var { newText } = action
  switch (action.type) {
...
var todoPartDeuxReducerInitial = {
  todos:[
    {text:'Ensure proper temperature of cryogenic chambers', completed: false, id: uuid()},
    {text:'Recalibrate fusion generators', completed: false, id: uuid()},
    {text:"Adjust planetary slingshot angle", completed: false, id: uuid()}
  ],
  searchKey:""
}
export const todoPartDeuxReducer = (state = todoPartDeuxReducerInitial, action) => {
